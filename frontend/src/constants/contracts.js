...
/** Compatibility exports retained for older components/tests; the public Research surface does not render this unpublished file. */
export const THESIS_CANONICAL_URL = `${GITHUB_REPO}/blob/main/energy_constraint_thesis_final_submission_revised.pdf`;
export const THESIS_LINK_STATUS = "final_revised_pdf_not_embedded_in_public_lab_release";
