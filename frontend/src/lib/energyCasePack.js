...
import cptCase from '../../../protocol/cases/energy-v1/cases/CPT-001.json';
...
import cptEvidence from '../../../protocol/cases/energy-v1/evidence/cpt-sample-evidence.json';
...
import cptContext from '../../../protocol/cases/energy-v1/contexts/cpt-resource-context.json';
...
const cases = [tynCase, ausCase, phxCase, opsCase, cptCase];
const evidence = [tynEvidence, ausEvidence, phxEvidence, opsEvidence, cptEvidence];
const contexts = [tynContext, ausContext, phxContext, cptContext];
