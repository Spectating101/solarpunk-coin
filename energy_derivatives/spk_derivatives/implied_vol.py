...
def implied_volatility_bisection(
    ...
    try:
        ...
        return {"implied_vol": np.nan, "iterations": 0, "converged": False, "final_error": np.inf}
...
def implied_vol_surface(market_data: pd.DataFrame, S0: float, r: float) -> pd.DataFrame:
    """
...
def volatility_smile_moneyness(
    market_data: pd.DataFrame, S0: float, fixed_maturity: float
