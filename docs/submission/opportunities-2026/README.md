# Policy Lab — Verified Opportunity Pack (2026-08-25)
...
[`global-ai-finance-2026/POSTER_EXTENDED_ABSTRACT.md`](./global-ai-finance-2026/POSTER_EXTENDED_ABSTRACT.md)
...
### JOSS — prepare now, submit after external impact signal

[`joss/JOSS_READINESS_GATE.md`](./joss/JOSS_READINESS_GATE.md)

The missing gate is external research impact/community significance, not more code.

### NLnet Restack — wait for September 3 call-specific hard criteria

[`nlnet-restack/RESTACK_GATE.md`](./nlnet-restack/RESTACK_GATE.md)
...
- No advisor is invented.
- No AI contribution is invented.
- No pilot/customer/adoption evidence is invented.
