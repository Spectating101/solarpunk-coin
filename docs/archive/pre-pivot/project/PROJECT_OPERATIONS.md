...
> [!WARNING]
> **Historical snapshot (pre-pivot).** This file contains pre-2026-04-20 operating assumptions (including Amoy/older test-count era) and is not the canonical current-state source.
>
...
> - `EVIDENCE.md`
> - `MASTER_HANDOFF.md`
> - `docs/INDEX.md` (canonical map + precedence rules)
