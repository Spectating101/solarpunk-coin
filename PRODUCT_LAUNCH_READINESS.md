...
| SPK intelligence layer | `scripts/spk_intelligence_layer.js` scores operator readings against NASA/PV benchmark expectations | Adds advisory anomaly scoring and audit explanations without making AI a mint authority |
...
- The SPK intelligence layer demonstrates the optional AI/statistical angle: current sample scores `7` rows against a NASA/PV benchmark and generates an advisory audit note while keeping contracts as the only mint authority.
